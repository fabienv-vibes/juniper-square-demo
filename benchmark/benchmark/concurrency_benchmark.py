...
def benchmark_level(
    ...
    for q in queries:
        ...
        if latencies:
            wall_time_s = sum(latencies) / 1000  # approximate
...
def main():
    ...
    # Expand queries by weight. Keeps the existing round-robin-within-expanded-list behavior.
    ...
    # Log the weighted expansion so we can confirm the mix
